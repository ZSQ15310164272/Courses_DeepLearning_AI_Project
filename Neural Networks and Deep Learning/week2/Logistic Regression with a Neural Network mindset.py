# -*- coding: utf-8 -*-
"""
Created on Sat Jul 28 10:28:57 2018
...
"""
-------------------------------------------------------------------------------
Stage 2: Overview of the Problem set
-------------------------------------------------------------------------------
"""
...
"""
-------------------------------------------------------------------------------
Stage 3 : General Architecture of the learning algorithm
-------------------------------------------------------------------------------
"""

"""
-------------------------------------------------------------------------------
Stage 4: Building the parts of our algorithm
-------------------------------------------------------------------------------
"""
## Define sigmoid acitivated function.
def sigmoid(z):
...
"""
-------------------------------------------------------------------------------
Stage 5: Merge all functions into a model
-------------------------------------------------------------------------------
"""
...
if __name__ == "__main__":
    ...
    """
    ---------------------------------------------------------------------------
    Stage 6: Further analysis (optional/ungraded exercise)
    ---------------------------------------------------------------------------
    """
    ...
    """
    ---------------------------------------------------------------------------
    Stage 7: Test with your own image (optional/ungraded exercise))
    ---------------------------------------------------------------------------
    """
    ...
    my_image = scipy.misc.imresize(image, size=(num_px, num_px)).reshape((1, 
                                  num_px*num_px*3)).T
    my_pedicted_image = predict(d["w"], d["b"], my_image)
    
    plt.imshow(image)
    print("y = " + str(np.squeeze(my_pedicted_image)) + 
          ", your algorithm predicts a \"" + 
          classes[int(np.squeeze(my_pedicted_image)),].decode("utf-8") 
          +  "\" picture.")  
