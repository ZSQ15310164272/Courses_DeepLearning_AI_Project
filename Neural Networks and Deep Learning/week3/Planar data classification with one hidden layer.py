# -*- coding: utf-8 -*-
"""
Created on Sat Jul 28 16:02:50 2018
...
"""
-------------------------------------------------------------------------------
Stage 3: Simple Logistic Regression
-------------------------------------------------------------------------------
"""
...
def nn_model(X, Y, n_h, num_iterations=10000, print_cost=False):
    ...
    for i in range(0, num_iterations):
        ...
        # Outputs: "parameters".
        parameters = updata_parameters(parameters, grads)
...
if __name__ == "__main__":
    ...
    """
    ---------------------------------------------------------------------------
    Stage 5 Performance on other datasets
    ---------------------------------------------------------------------------
    """
    # Datasets
