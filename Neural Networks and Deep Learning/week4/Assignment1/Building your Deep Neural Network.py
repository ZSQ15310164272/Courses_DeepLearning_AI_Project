# -*- coding: utf-8 -*-
"""
Created on Sat Jul 28 20:09:00 2018
...
"""
-------------------------------------------------------------------------------
Stage 2 :Outline of the Assignment
-------------------------------------------------------------------------------
"""
...
"""
-------------------------------------------------------------------------------
Stage 4: Forward propagation module
-------------------------------------------------------------------------------
"""
...
def L_model_forward(X, parameters):
    ...
    ### START CODE HERE ### (≈ 2 lines of code)
    AL, cache = linear_activation_forward(A, parameters['W'+str(layer)],
                                                        parameters['b'+str(L)], 
                                                        activation = "sigmoid")
    ### END CODE HERE ###
...
"""
-------------------------------------------------------------------------------
Stage 6: Backward propagation module
-------------------------------------------------------------------------------
"""
...
def L_model_backward(Al, Y, caches):
    ...
    for layer in reversed(range(L-1)):
        ...
        dA_prev_temp, dW_temp, db_temp = linear_activation_backward(grads["dA" + 
                        str(layer+2)], current_cache, 'relu')
...
def updata_parameters(parameters, grads, learning_rate):
    ...
    for layer in range(L):
        parameters['W'+str(layer+1)] = parameters["W" + str(layer+1)] \
                - learning_rate * grads["dW" + str(layer+1)]
        parameters["b" + str(layer+1)] = parameters["b" + str(layer+1)] \
