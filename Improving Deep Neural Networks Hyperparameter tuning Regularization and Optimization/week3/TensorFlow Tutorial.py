# -*- coding: utf-8 -*-
"""
Created on Sun Jul 29 11:00:04 2018
...
"""
Stage 1: Exploring the Tensorflow Library
"""
import os 
import math
import numpy as np
...
"""
-------------------------------------------------------------------------------
Stage 2: Building your first neural network in tensorflow
-------------------------------------------------------------------------------
"""
# Loading the dataset
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            ...
            for minibatch in minibatches:
                ...
                ### START CODE HERE ### (1 line)
                _, minibatch_cost = sess.run([optimizer, cost], feed_dict={X: 
                    minibatch_X, Y: minibatch_Y})
                ### END CODE HERE ###
